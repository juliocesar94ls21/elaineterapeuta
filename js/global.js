...
animateOnScroll('.title-header-bg', 'animate__fadeInUp');
animateOnScroll('.paragraf-header-bg', 'animate__fadeInUp');
animateOnScroll('.btn-primary-bf', 'animate__fadeInUp');
animateOnScroll('.col-card-bf', 'animate__fadeInUp');
animateOnScroll('.title-card-bf', 'animate__fadeInUp');
animateOnScroll('.paragraf-card-bf', 'animate__fadeInUp');
animateOnScroll('.col-img-el', 'animate__fadeInLeft');
animateOnScroll('.title-content-qs', 'animate__fadeInUp');
animateOnScroll('.desc-content-qs', 'animate__fadeInUp');
animateOnScroll('.col-data', 'animate__fadeInUp');
animateOnScroll('.unwrap-desc-qs', 'animate__fadeInUp');
animateOnScroll('.col-foto-elaine', 'animate__fadeInUp');
animateOnScroll('.inner-dp-text', 'animate__fadeInUp');
animateOnScroll('.inner-dp-desc', 'animate__fadeInUp');
animateOnScroll('.col-test-item', 'animate__fadeInUp');
animateOnScroll('.col-iframe-left', 'animate__fadeInLeft');
animateOnScroll('.col-iframe-right', 'animate__fadeInRight');
animateOnScroll('.col-poster-bc', 'animate__fadeInRight');
animateOnScroll('.text-input-bc', 'animate__fadeInUp');
